...
public class Ejercicio12 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Total de Manzanas en el año %.2f (Kg), con un importe de %.2f€%n", manzanasTotalKg, importeDeManzanas);
        System.out.printf("Total de Peras en el año %.2f (Kg), con un importe de %.2f€%n", perasTotalKg, importeDePeras);
